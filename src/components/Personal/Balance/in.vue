<template>
    <div class="in">
        ...
        <div id='Transfer' class="lotty_name">
            ...
            <div style="margin-top:0.3rem" class="item click-item">
                <div @click='insubmit' class="access_bnt bnt1">转 账</div>
            </div>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        mounted:function() {
            this.inbalancevalidation();
        },
        methods :{
            inbalancevalidation:function () {
                var vm= this;
            ...
            insubmit:function(){
                ...
                if(Smoney == ""){
                    ...
                    vm.$transferTo(data,vm.jrg+'User/TransferTo',vm,token);
                }
            }
        },
        created() {
